...
- **Learning Journals**: Conceptual understanding and technical learning
- **Projects**: Sustained research questions and investigations
- **Essays**: Methodological reflection and interdisciplinary synthesis
- **Technical Notes**: Technical implementation and reproducibility

This structure allows content to evolve naturally—a learning journal may inspire a project, a project may generate an essay, and all may produce technical notes. The website architecture mirrors the actual process of research.
...
```
Home
├── Learning Journals  (Learning, concepts, technical intuition)
├── Projects           (Research investigations, ongoing work)
├── Essays             (Methodology, reflection, synthesis)
├── Technical Notes    (Implementation, tools, reproducibility)
...
- **Learning Journals** capture the process of understanding—they document how you came to know something, not just what you know
...
- **Technical Notes** ground abstract ideas in concrete implementation—they ensure reproducibility and practical utility

This structure supports the full cycle of research: learning (Learning Journals), investigating (Projects), reflecting (Essays), and implementing (Technical Notes).
...
3. **Latest Learning Journals**: 3-5 recent entries showing current learning focus
...
## Learning Journals Section

### Definition and Scope

Learning journals are **learning artifacts**—they document the process of understanding concepts, techniques, and theories. A journal entry is not a summary of a textbook chapter or lecture; it is a personal reconstruction of an idea in your own terms.

**What distinguishes a learning journal from other content?**

- **Learning journals are conceptual**: They focus on understanding "why" and "how," not just "what"
- **Learning journals are technical**: They may include derivations, proofs, or detailed explanations
- **Learning journals are iterative**: A journal entry can be updated as understanding deepens
- **Learning journals are atomic**: Each entry should address a specific concept or technique

**Learning Journals vs. Course Assignments**

Course assignments are exercises designed to test understanding within a pedagogical framework. Learning journals are self-directed explorations that may draw from multiple courses or extend beyond course material. An assignment becomes a journal entry when you reframe it around a question that matters to you, not just to the course requirements.

**Learning Journals vs. Drafts**

Drafts are incomplete or provisional. Learning journals are complete expressions of current understanding—they may be revised, but they are not "unfinished." If you're not ready to explain an idea clearly, it's not yet a journal entry.
...
### Learning Journals Upload Workflow

#### Step 1: Prepare Content

If starting from LaTeX notes:
- Convert to Markdown (use Pandoc or manual conversion)
- Ensure math is in LaTeX format (rendered in the browser by KaTeX)
...
> Math does not need a front-matter flag: LaTeX is rendered in the browser by KaTeX on every entry page automatically.
...
Navigate to `http://localhost:4000/learning-journals/` to verify the entry appears correctly.

#### Step 5: Publish

Once satisfied, commit and push. GitHub Actions builds and deploys the site automatically:
```bash
git add .
git commit -m "Add note: Descriptive Title"
...
**Projects vs. Learning Journals**

- Learning journals are about understanding; projects are about discovering
- Learning journals explain what is known; projects explore what is unknown
- Learning journals are complete; projects are ongoing (and that's legitimate)
...
**Essays vs. Learning Journals**

- Learning journals explain concepts; essays argue about ideas
- Learning journals are technical; essays are conceptual
- Learning journals are domain-specific; essays are often interdisciplinary
...
The Technical Notes section is an **index of implementations**, not a code repository itself. Each entry documents a piece of software, script, or tool you've developed, with enough information that someone could use it.
...
### Technical Note Entry Structure

Each technical-note entry should include:
...
The Technical Notes section is **documentation**, not a substitute for version control. The actual code should live in a GitHub repository. The website entry provides:
...
### About vs. Learning Journals/Essays

The About page is **declarative** (this is who I am), while Learning Journals and Essays are **demonstrative** (this is how I think). Both are necessary. The About page provides context; the content provides evidence.
...
**Learning Journals**: Add new entries as you learn significant concepts. Aim for 1-2 per month during active learning periods. Quality over quantity—one deep entry is better than five shallow ones.
...
**Technical Notes**: Add entries when you complete a significant implementation. Update existing entries if functionality changes.
...
**Year 1**: The site is primarily a learning record. Learning journals dominate. Projects are exploratory. Essays are rare.

**Year 2**: Projects become more substantial. Essays emerge as you develop methodological opinions. Learning journals become more selective and deeper.

**Year 3+**: The site is a research archive. Projects are central. Essays demonstrate intellectual maturity. Learning journals are highly focused on research-relevant concepts.
